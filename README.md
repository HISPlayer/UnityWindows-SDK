...
> **[HISPlayer Video Upload / Hosting](https://hisplayer.github.io/UnityVideoUpload/#/README)** is a new feature of our **Unity Video Player SDK**. It allows you to upload local video files to our server and transcode them into HLS and DASH streaming formats directly from our Unity SDK. Need to convert your videos content into HLS and DASH streams for broadcast and cross-platform delivery at scale? **[Start your FREE trial here!](https://dashboard.hisplayer.com/signup)**
>
>  ### Steps to use:
